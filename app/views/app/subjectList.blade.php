                            ...
                            <table id="subjectList" class="table table-striped table-bordered table-hover">
                             ...
                             <!--       <th>Group</th>
                               ...
                               <!--         <td>{{$subject->subgroup}}</td>
                                        ...
                                        <td>
                                            {{'Total = ' . $subject->totalfull . '%'}}<br>
                                            {{'Quiz = ' . $subject->wfull . '%'}}<br>
                                            {{'Exam = ' . $subject->mfull . '%'}}<br>
                                            {{'Oral = ' . $subject->sfull . '%'}}<br>
                                            {{'Extra = ' . $subject->pfull . '%'}}
                                        </td>
                                        <td>
                                            {{'Total = ' . $subject->totalpass . '%'}}<br>
                                            {{'Quiz = ' . $subject->wpass . '%'}}<br>
                                            {{'Exam = ' . $subject->mpass . '%'}}<br>
                                            {{'Oral = ' . $subject->spass . '%'}}<br>
                                            {{'Extra = ' . $subject->ppass . '%'}}
                                        </td>
                                        <td>
